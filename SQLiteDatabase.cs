namespace SQLiteWrap
{
    ...
    public class SQLiteDatabase
    {
        ...
        {
            get { return Path.Combine(_DBFilePath, _DBFileName); }
        }
        ...
        /// </summary>
        public bool MutliThreadAccess
        {
            get { return _MutliThreadAccess; }
        }
        ...
        private void ConstructConnection(bool overWriteFile = false)
        {
            ...
            if (File.Exists(dbFileNamePath) == false)
            {
        ...
        {
            return MutliThreadAccess ? SQLiteJournalModeEnum.Wal : SQLiteJournalModeEnum.Default;
        }
